...
import './Chooseus.css';
import Icon from '/icon.png'; // Ensure this path is correct

import ChooseImg from '/choose.png'; // Ensure this path is correct
import ChooseBgImg from '/choosebg.png'; // Ensure this path is correct
